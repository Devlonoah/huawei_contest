...
//   static TextStyle get _whiteHeadline3 => _poppinsTheme.headline3!.copyWith(
//         color: Colors.white,
//         fontFamily: 'Poppins',
//       );

//   static TextStyle get _whiteHeadline2 => _poppinsTheme.headline2!.copyWith(
//         color: Colors.white,
//         fontFamily: 'Poppins',
//       );

// //Textheme to be used in light theme
//   static TextStyle get _blackHeadline6 => _poppinsTheme.headline6!.copyWith(
//         color: Colors.grey,
//         fontFamily: 'Poppins',
//       );

//   static TextStyle get _blackHeadline3 => _poppinsTheme.headline3!.copyWith(
//         color: Colors.grey,
//         fontFamily: 'Poppins',
//       );

//   static TextStyle get _blackHeadline2 => _poppinsTheme.headline2!.copyWith(
//         color: Colors.white,
//         fontFamily: 'Poppins',
//       );
